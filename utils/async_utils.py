...
async def run_coro_with_timeout(coro, timeout):
...
async def safe_db_operation(db, operation, default_return=None):
    """
    ...
    Returns:
        The result of the operation or default_return if it fails
    """
    if db is None:
