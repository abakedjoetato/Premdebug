...
class Bounty(BaseModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._id = None
        self.bounty_id = bounty_id if bounty_id is not None else str(uuid.uuid4())
    ...
    async def get_player_stats_for_bounty(
        ...
        async for doc in cursor:
            ...
            # Add player if they meet criteria
            if meets_killstreak or meets_fixation:
                player_info = {
                    "player_id": player_id,
                ...
                if meets_fixation and fixation_target:
