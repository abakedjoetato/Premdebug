            ...
            try:
                ...
                if use_sftp:
                    ...
                    try:
                        ...
                        logger.error(f"SFTP download failed: {str(e)}")
                        result["error"] = f"SFTP download failed: {str(e)}"
                ...
                try:
                    ...
                    for csv_file in map_files:
                        try:
                            ...
                            logger.error(f"Error processing map file {csv_file}: {str(e)}")
                            result["errors"].append(f"Error processing map file {csv_file}: {str(e)}")
                    ...
                    result["error"] = f"Error discovering CSV files: {str(e)}"
                    result["errors"].append(str(e))
